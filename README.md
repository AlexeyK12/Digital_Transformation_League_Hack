...
13. **Управление временными задержками:**
    - time

14. **Установка параметров для взаимодействия с базой данных (в блокноте):**
    - IPython.display
    - Javascript

15. **Библиотека для заглушки случайных данных:**
    - Random (заглушка для воспроизводимости результатов)
